...
public:
    ...
    void rehash(std::string* old_t0, std::string* old_t1, unsigned old_cap);
...
private:
    ...
    unsigned thresh = DEFAULT_EVICT_THRESHOLD;
    unsigned cap, num_keys;
    std::string* t0;
    std::string* t1;
...
bool isPrime(unsigned cap, unsigned prime);
